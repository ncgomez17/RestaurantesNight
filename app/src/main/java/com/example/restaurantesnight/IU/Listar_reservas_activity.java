    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LV_RESERVAS.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            public boolean onItemLongClick(AdapterView<?> parent, View view, int pos, long id) {
                AlertDialog.Builder adb=new AlertDialog.Builder(Listar_reservas_activity.this);
                ...
                adb.setPositiveButton("Ok", new AlertDialog.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        Listar_reservas_activity.this.sqlIO.eliminar_Reserva((titular.getText().toString()));;
                        Listar_reservas_activity.this.actualiza(id_m);
